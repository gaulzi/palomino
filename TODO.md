# TODO — Palomino Yearling 4102 manual

Tracking file for the manual in [`README.md`](README.md). Keeps the manual itself clean.

**Workflow:** drop new photos in this folder (HEIC is fine → they'll be converted to JPG in
`images/`), note which system each shows, then the matching section in `README.md` gets
filled in and the item below ticked off.
...
- [ ] **Shore-power hook-up** — confirm supply is earthed with **RCD/RCBO** protection. (§2.2)
- [ ] Full electrical inspection of the EU conversion by a qualified person. (§9)
...
- [ ] Make/model label
- [ ] Burner count + ignition type + flame-failure device

### 7. Structure & body — README §6–§8
- [ ] Lift mechanism + raise/lower sequence
- [ ] Canvas / tent, latches
- [ ] Interior: dinette/bed conversion, storage, switch locations
- [ ] Exterior: tie-downs/mounts, jacks, door, windows, hatches, lights

---

## ✍️ Sections still to write (once photos arrive)
...
- [ ] §8 Exterior & hardware
- [ ] §1 Unit identification — confirm 4102 is the soft-side pop-up floorplan

## 💡 Optional / nice-to-have

- [ ] Add a **winterising / drain-down checklist** as its own section
- [ ] Add a **Truma fault-code reference** table
- [ ] Set up **PDF export** of the manual for printing
- [ ] Add a wiring diagram (redraw the ASCII schematic as a proper image)
